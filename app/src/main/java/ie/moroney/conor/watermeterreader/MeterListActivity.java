...
import ie.moroney.conor.watermeterreader.dummy.DummyContent;
...
public class MeterListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View recyclerView = findViewById(R.id.meter_list);
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        arguments.putString(MeterDetailFragment.ARG_ITEM_ID, holder.mItem.id);
                        ...
                        intent.putExtra(MeterDetailFragment.ARG_ITEM_ID, holder.mItem.id);
